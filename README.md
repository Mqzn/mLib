...
### Artifact Dependency
You can download the jar directly from [here](../../releases/tag/1.2.1), and use it as an artifact.
...
You can download the jar directly from [here](../../releases/tag/1.2.1), and place it in your plugins folder like any other, restart your server, and away you go!
